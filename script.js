...
let questions = [
    ...
    {
        prompt: 'The property in CSS used to change the text color of an element is?',
    ...
    {
        prompt: 'Which of the following is the correct syntax for referring the external style sheet?',

        options: ["<style src = example.css>",
